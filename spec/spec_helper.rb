...
RSpec.configure do |config|
  ...
  def create_vm_host(**args)
    args = {location_id: "caa7a807-36c5-8420-a75c-f906839dad71", allocation_state: "accepting", arch: "x64", total_cores: 48, used_cores: 2}.merge(args)
  ...
  def create_vm(**args)
    defaults = {unix_user: "ubi", public_key: "ssh-ed25519 key", name: "test-vm", family: "standard", cores: 0, vcpus: 2, cpu_percent_limit: 200, cpu_burst_percent_limit: 0, memory_gib: 8, arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", boot_image: "ubuntu-jammy", display_state: "running", ip4_enabled: false, created_at: Time.now}
  ...
  def add_ipv4_to_vm(vm, ipv4)
    host = VmHost.new_with_id(allocation_state: "accepting", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cores: 10, used_cores: 3)

...
RSpec.describe Prog::Test::VmGroup do
  ...
  describe "#verify_connected_subnets" do
    ...
    it "runs tests for the first connected subnet" do
      ...
      ps1 = Prog::Vnet::SubnetNexus.assemble(prj.id, name: "ps1", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
      ps2 = Prog::Vnet::SubnetNexus.assemble(prj.id, name: "ps2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject

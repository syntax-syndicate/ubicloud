...
' | sudo tee /etc/systemd/system/listening_ipv6.service > /dev/null")
  ...
  describe ".vm_outside" do
    it "returns the vm outside" do
      ...
      ps = Prog::Vnet::SubnetNexus.assemble(prj.id, name: "ps2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
      Prog::Vm::Nexus.assemble("", prj.id, name: "vm-outside", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", private_subnet_id: ps.id).subject

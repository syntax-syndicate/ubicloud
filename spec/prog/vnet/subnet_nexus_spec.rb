...
RSpec.describe Prog::Vnet::SubnetNexus do
  ...
  let(:ps) {
    PrivateSubnet.create_with_id(name: "ps", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", net6: "fd10:9b0b:6b4b:8fbb::/64",
      net4: "1.1.1.0/26", state: "waiting", project_id: prj.id)
  }

  let(:ps2) {
    PrivateSubnet.create_with_id(name: "ps2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", net6: "fd10:9b0b:6b4b:8fcc::/64",
  ...
  describe ".assemble" do
    ...
    it "uses firewall if provided" do
      fw = Firewall.create_with_id(name: "default-firewall", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: prj.id)
    ...
    it "fails if firewall is not in the project" do
      fw = Firewall.create_with_id(name: "default-firewall", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: Project.create(name: "t2").id)
      expect {
  ...
  describe ".random_private_ipv4" do
    ...
    it "finds a new subnet if the one it found is taken" do
      ...
      described_class.assemble(project.id, location_id: "caa7a807-36c5-8420-a75c-f906839dad71", name: "test-subnet", ipv4_range: "10.0.0.128/26")
  ...
  describe ".random_private_ipv6" do
    ...
    it "finds a new subnet if the one it found is taken" do
      project = Project.create_with_id(name: "test-project")
      described_class.assemble(project.id, location_id: "caa7a807-36c5-8420-a75c-f906839dad71", name: "test-subnet", ipv6_range: "fd61:6161:6161:6161::/64")
  ...
  describe "#destroy" do
    ...
    it "extends deadline if a vm prevents destroy" do
      vm = Vm.new(family: "standard", cores: 1, name: "dummy-vm", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").tap {

...
RSpec.describe Prog::Minio::MinioClusterNexus do
  subject(:nx) {
    ...
    described_class.new(
      described_class.assemble(
        minio_project.id, "minio", "caa7a807-36c5-8420-a75c-f906839dad71", "minio-admin", 100, 1, 1, 1, "standard-2"
      )
    )
  }
  ...
  describe ".assemble" do
    ...
    it "validates input" do
      expect {
        described_class.assemble(SecureRandom.uuid, "minio", "caa7a807-36c5-8420-a75c-f906839dad71", "minio-admin", 100, 1, 1, 1, "standard-2")
      }.to raise_error RuntimeError, "No existing project"

      expect {
        described_class.assemble(minio_project.id, "minio/name", "caa7a807-36c5-8420-a75c-f906839dad71", "minio-admin", 100, 1, 1, 1, "standard-2")
      }.to raise_error Validation::ValidationFailed, "Validation failed for following fields: name"

      expect {
        described_class.assemble(minio_project.id, "minio", "caa7a807-36c5-8420-a75c-f906839dad71", "mu", 100, 1, 1, 1, "standard-2")
      }.to raise_error Validation::ValidationFailed, "Validation failed for following fields: username"
    end

    it "creates a minio cluster" do
      described_class.assemble(minio_project.id, "minio2", "caa7a807-36c5-8420-a75c-f906839dad71", "minio-admin", 100, 1, 1, 1, "standard-2")

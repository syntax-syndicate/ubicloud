...
RSpec.describe Prog::Postgres::PostgresTimelineNexus do
  ...
  describe "#start" do
    ...
    it "creates bucket and hops" do
      ...
      expect(Minio::Client).to receive(:new).with(endpoint: "https://blob-endpoint", access_key: "admin", secret_key: "secret", root_certs: ["certs"]).and_return(admin_blob_storage_client)
  ...
  describe "#destroy" do
    ...
    it "destroys blob storage and postgres timeline" do
      ...
      expect(Minio::Client).to receive(:new).with(endpoint: postgres_timeline.blob_storage_endpoint, access_key: "admin", secret_key: "secret", root_certs: ["certs"]).and_return(admin_blob_storage_client)

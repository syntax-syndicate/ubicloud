...
RSpec.describe Prog::Ai::InferenceEndpointNexus do
  ...
  describe ".assemble_with_model" do
    ...
    it "assembles with model" do
      ...
      described_class.assemble_with_model(project_id: 1, location_id: "caa7a807-36c5-8420-a75c-f906839dad71", name: "test-endpoint", model_id: "model_id")
    end
    ...
    it "raises an error if model is not found" do
      ...
      expect {
        described_class.assemble_with_model(project_id: 1, location_id: "caa7a807-36c5-8420-a75c-f906839dad71", name: "test-endpoint", model_id: "invalid_id")

...
RSpec.describe Prog::Vm::VmPool do
  ...
  describe ".assemble" do
    it "creates the entity and strand properly" do
      st = described_class.assemble(
        size: 3, vm_size: "standard-2", boot_image: "img", location_id: "caa7a807-36c5-8420-a75c-f906839dad71",
      ...
      expect(pool.location_id).to eq("caa7a807-36c5-8420-a75c-f906839dad71")
  ...
  describe "#destroy" do
    let(:pool) {
      VmPool.create_with_id(size: 0, vm_size: "standard-2", boot_image: "img", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", storage_size_gib: 86)
    }

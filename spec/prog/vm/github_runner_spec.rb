...
RSpec.describe Prog::Vm::GithubRunner do
  ...
  describe "#wait_concurrency_limit" do
    before do
      [["caa7a807-36c5-8420-a75c-f906839dad71", "x64"], ["6b9ef786-b842-8420-8c65-c25e3d4bdf3d", "x64"], ["6b9ef786-b842-8420-8c65-c25e3d4bdf3d", "arm64"]].each_with_index do |(location_id, arch), i|
  ...
  describe ".setup_info" do
    it "returns setup info with vm pool ubid" do
      ...
      expect(vm).to receive(:vm_host).and_return(instance_double(VmHost, ubid: "vhfdmbbtdz3j3h8hccf8s9wz94", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", data_center: "FSN1-DC8")).at_least(:once)
  ...
  describe "#setup_environment" do
    it "hops to register_runner" do
      ...
      expect(vm).to receive(:vm_host).and_return(instance_double(VmHost, ubid: "vhfdmbbtdz3j3h8hccf8s9wz94", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", data_center: "FSN1-DC8", id: "788525ed-d6f0-4937-a844-323d4fd91946")).at_least(:once)

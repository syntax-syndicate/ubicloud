...
RSpec.describe Al do
  let(:vm) {
    Vm.new(family: "standard", vcpus: 2, cpu_percent_limit: 200, cpu_burst_percent_limit: 0, memory_gib: 8, name: "dummy-vm", arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", ip4_enabled: "true", created_at: Time.now, unix_user: "", public_key: "", boot_image: "ubuntu-jammy").tap {
  ...
  describe "candidate_selection" do
    ...
    it "disqualifies invalid candidates" do
      vmh1 = create_vm_host(allocation_state: "accepting", arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cores: 7, used_cores: 6, total_hugepages_1g: 10, used_hugepages_1g: 2)
      vmh2 = create_vm_host(allocation_state: "draining", arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cores: 8, used_cores: 1, total_hugepages_1g: 8, used_hugepages_1g: 2)
      vmh3 = create_vm_host(allocation_state: "accepting", arch: "arm64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cores: 8, used_cores: 0, total_hugepages_1g: 8, used_hugepages_1g: 0)
      vmh4 = create_vm_host(allocation_state: "accepting", arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cores: 8, used_cores: 6, total_hugepages_1g: 8, used_hugepages_1g: 5)
    ...
    it "applies location filter" do
      vmh1 = create_vm_host(location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2)
      ...
      req.location_filter = ["caa7a807-36c5-8420-a75c-f906839dad71"]
      cand = Al::Allocation.candidate_hosts(req)
  ...
  describe "Allocation" do
    ...
    it "respects location preferences" do
      ...
      req.location_preference = ["caa7a807-36c5-8420-a75c-f906839dad71"]
      expect(Al::VmHostCpuAllocation).to receive(:new).and_return(TestResourceAllocation.new(0, true))
      expect(Al::VmHostAllocation).to receive(:new).and_return(TestResourceAllocation.new(0, true))
      expect(Al::StorageAllocation).to receive(:new).and_return(TestResourceAllocation.new(0, true))
  ...
  describe "slice selection" do
    ...
    it "creates a vm with a slice" do
      ...
      ps = PrivateSubnet.create_with_id(name: "test-ps", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", net6: "2001:db8::/64", net4: "10.0.0.0/24", project_id: vm.project.id)
    ...
    it "prefers a host with available slice for burstables" do
      ...
      vh2 = VmHost.create(allocation_state: "accepting", arch: "x64", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", total_mem_gib: 64, total_sockets: 2, total_dies: 2, net6: "fd10:9b0b:6b4b:8fcc::/64", total_cpus: 16, total_cores: 8, used_cores: 1, total_hugepages_1g: 54, used_hugepages_1g: 2, accepts_slices: true) { _1.id = Sshable.create_with_id.id }

...
RSpec.describe PrivateSubnet do
  ...
  describe "destroy" do
    it "destroys firewalls private subnets" do
      ps = described_class.create_with_id(name: "test-ps", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", net6: "2001:db8::/64", net4: "10.0.0.0/24", project_id: Project.create(name: "test").id)
  ...
  describe "connected subnets related methods" do
    ...
    let(:ps1) {
      Prog::Vnet::SubnetNexus.assemble(prj.id, name: "test-ps1", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
    }

    it ".connected_subnets" do
      ps2 = Prog::Vnet::SubnetNexus.assemble(prj.id, name: "test-ps2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
      ...
      ps3 = Prog::Vnet::SubnetNexus.assemble(prj.id, name: "test-ps3", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject

...
RSpec.describe VmHost do
  ...
  it "requires an Sshable too" do
    expect {
      ...
      described_class.create(location_id: "caa7a807-36c5-8420-a75c-f906839dad71") { _1.id = sa.id }
    }.not_to raise_error
  end
  ...
  it "create_addresses fails if a failover ip of non existent server is being added" do
    ...
    described_class.create(location_id: "caa7a807-36c5-8420-a75c-f906839dad71") { _1.id = vh.id }
  ...
  it "updates the routed_to_host_id if the address is reassigned to another host and there is no vm using the ip range" do
    ...
    described_class.create(location_id: "caa7a807-36c5-8420-a75c-f906839dad71") { _1.id = old_id }

...
RSpec.describe Nic do
  ...
  describe "ubid_to_tap_name" do
    let(:subnet) { PrivateSubnet.create_with_id(net6: "0::0", net4: "127.0.0.1", name: "x", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: Project.create(name: "test").id) }

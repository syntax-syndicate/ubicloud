...
RSpec.describe GithubRunner do
  ...
  it "can log duration when it's from a vm pool" do
    pool = VmPool.create_with_id(size: 1, vm_size: "standard-2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", boot_image: "github-ubuntu-2204", storage_size_gib: 86)

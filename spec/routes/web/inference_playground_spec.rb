  ...
  describe "feature enabled" do
    ...
    it "gives choice of inference endpoints" do
      ...
      [
        ...
        InferenceEndpoint.create_with_id(name:, model_name:, project_id: project.id, is_public:, visible:, load_balancer_id:, location_id: "caa7a807-36c5-8420-a75c-f906839dad71", vm_size: "size", replica_count: 1, boot_image: "image", storage_volumes: [], engine_params: "", engine: "vllm", private_subnet_id: ps.id, tags:)
      end
      visit "#{project.path}/inference-playground"

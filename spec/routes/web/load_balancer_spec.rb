...
RSpec.describe Clover, "load balancer" do
  ...
  let(:lb_wo_permission) {
    ps = Prog::Vnet::SubnetNexus.assemble(project_wo_permissions.id, name: "dummy-ps-2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "handles invalid referers by redirecting to root" do
        project
        Prog::Vnet::SubnetNexus.assemble(project.id, name: "dummy-ps-1", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject
        visit "#{project.path}/load-balancer/create"
        fill_in "Name", with: "invalid name"
      ...
      it "can not create load balancer in a project when does not have permissions" do
        Prog::Vnet::SubnetNexus.assemble(project_wo_permissions.id, name: "dummy-ps-1", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject

...
RSpec.describe Clover, "private subnet" do
  ...
  let(:private_subnet) do
    ps_id = Prog::Vnet::SubnetNexus.assemble(project.id, name: "dummy-ps-1", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").id
  ...
  describe "authenticated" do
    ...
    describe "show firewalls" do
      it "can show attached firewalls" do
        private_subnet
        fw = Firewall.create_with_id(name: "dummy-fw", description: "dummy-fw", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: project.id)
    ...
    describe "connected subnets" do
      it "can show connected subnets" do
        private_subnet
        ps2 = Prog::Vnet::SubnetNexus.assemble(project.id, name: "dummy-ps-2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject

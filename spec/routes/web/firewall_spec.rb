...
RSpec.describe Clover, "firewall" do
  ...
  let(:firewall) do
    Firewall.create_with_id(name: "dummy-fw", description: "dummy-fw", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: project.id)
  end

  let(:fw_wo_permission) {
    Firewall.create_with_id(name: "dummy-fw-2", description: "dummy-fw-2", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: project_wo_permissions.id)
  }
  ...
  describe "authenticated" do
    ...
    describe "list" do
      ...
      it "does not show links to firewalls if user lacks Firewall:view access to them" do
        firewall
        fw = Firewall.create_with_id(name: "viewable-fw", description: "viewable-fw", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: project.id)
    ...
    describe "subnets" do
      ...
      it "can detach subnet" do
        ps = Prog::Vnet::SubnetNexus.assemble(project.id, name: "dummy-ps-1111", location_id: "caa7a807-36c5-8420-a75c-f906839dad71").subject

...
RSpec.describe UBID do
  ...
  it "generates ids with proper prefix" do
    ...
    subnet = PrivateSubnet.create_with_id(net6: "0::0", net4: "127.0.0.1", name: "x", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id: prj.id)
  ...
  it "can decode ids" do
    ...
    subnet = PrivateSubnet.create_with_id(net6: "0::0", net4: "127.0.0.1", name: "x", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", project_id:)

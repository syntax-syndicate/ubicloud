...
class Prog::Vm::Nexus < Prog::Base
  ...
  def self.assemble(public_key, project_id, name: nil, size: DEFAULT_SIZE,
    unix_user: "ubi", location_id: "caa7a807-36c5-8420-a75c-f906839dad71", boot_image: Config.default_boot_image_name,
    ...
    begin
      ...
      allocation_state_filter, location_filter, location_preference, host_filter =
        if frame["force_host_id"]
          ...
          runner_locations = (vm.vcpus == 60) ? [] : [Location[name: "github-runners"].id, "caa7a807-36c5-8420-a75c-f906839dad71", Location[name: "hetzner-hel1"].id]
          [["accepting"], runner_locations, [Location[name: "github-runners"].id], []]
        else
